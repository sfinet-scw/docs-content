...
Scaleway offers several retention periods, depending on your [data types](/observability/cockpit/concepts/#data-types). The retention period varies depending on the [pricing plan](https://console.scaleway.com/cockpit/plans) you have selected.
